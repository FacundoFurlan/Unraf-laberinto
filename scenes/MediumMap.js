export default class MediumMap extends Phaser.Scene {
  constructor() {
      super('MediumMap');
  }
  ...
  preload() {
      ...
      this.load.tilemapTiledJSON('mapM', './public/assets/tilesetMEDIANO.json');
    ...
    // MAPA Y TILESET
    const map = this.make.tilemap({ key: 'mapM' });
